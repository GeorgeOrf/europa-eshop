  ...
  return (
    <>
        ...
        <div className="h-[90vh] bg-black rounded-[35px_35px] text-white flex justify-center items-center m-5">
          <div className="bg-white w-[500px] h-[400px] rounded-2xl shadow-[5px_5px_20px_white]">
            <div className="h-[75%] text-black m-5 flex flex-col items-center">
              <h2 className='self-center font-bold text-2xl p-5'>Register</h2>
              ...
              <input type="text" name='rptPassword' placeholder='Repeat your Password'
                className='w-full max-w-sm border-b-2 m-2 py-3 px-2 text-gray-800 focus:outline-none focus:border-black placeholder-gray-400'
              />
              <div className='w-[80%] flex justify-between'>
                <button className='m-2 border-2 p-1 rounded-md px-2 hover:border-white hover:text-white hover:bg-black transition-all duration-300 cursor-pointer'><Link to="/login">Already have an account?</Link></button>
